...
function library:unload()
	...
	for _, item in ipairs(library.instances) do
...
function library:make_draggable(frame)
	...
	frame.InputBegan:Connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 and frame.Draggable then
			dragging = true
...
function library:make_resizable(frame)
	...
	resize_button.Position = dim2(1, -10, 1, -10)
	resize_button.BorderColor3 = rgb(0, 0, 0)
	resize_button.Size = dim2(0, 10, 0, 10)
	resize_button.BorderSizePixel = 0
	resize_button.BackgroundColor3 = rgb(255, 255, 255)
	resize_button.Parent = frame
	resize_button.BackgroundTransparency = 1
	resize_button.Text = ""
	resize_button.ZIndex = frame.ZIndex + 1
...
function library:window(properties)
	...
	local inline1_wm = library:create("Frame", {
		Parent = __holder,
		Name = "",
		Active = true,
		Draggable = true,
	...
	library:make_draggable(inline1_wm)

	local accent_line_wm = library:create("Frame", {
		Parent = inline1_wm,
		Name = "",
	...
	library:apply_theme(accent_line_wm, "accent", "BackgroundColor3")

	local depth_wm = library:create("Frame", {
		Parent = inline1_wm,
		Name = "",
	...
	local inline2_wm = library:create("Frame", {
		Parent = inline1_wm,
		Name = "",
	...
	local main_wm = library:create("Frame", {
		Parent = inline2_wm,
		Name = "",
		Position = UDim2.new(0, 2, 0, 2),
	...
	local tab_inline_wm = library:create("Frame", {
		Parent = main_wm,
		Name = "",
	...
	local tabs_wm = library:create("Frame", {
		Parent = tab_inline_wm,
		Name = "",
		Position = UDim2.new(0, 2, 0, 2),
	...
	local name_wm = library:create("TextLabel", {
		Parent = tabs_wm,
		Name = "",
	...
	local glow_wm = library:create("ImageLabel", {
		Parent = accent_line_wm,
		Name = "",
	...
	library:apply_theme(glow_wm, "accent", "ImageColor3")
	...
	local name_esp = library:create("TextLabel", {
		Parent = esp_preview,
		Name = "",
		FontFace = library.font,
		TextColor3 = Color3.fromRGB(170, 170, 170),
	...
	local UIPadding_esp = library:create("UIPadding", {
		Parent = name_esp,
		Name = "",
	})

	local main_esp = library:create("Frame", {
		Parent = esp_preview,
		Name = "",
	...
	local tabs_esp = library:create("Frame", {
		Parent = main_esp,
		Name = "",
	...
	local accent_line_esp = library:create("Frame", {
		Parent = esp_preview,
		Name = "",
		BorderColor3 = Color3.fromRGB(34, 34, 34),
		Size = UDim2.new(1, 0, 0, 2),
	...
	library:apply_theme(accent_line_esp, "accent", "BackgroundColor3")

	local depth_esp = library:create("Frame", {
		Parent = esp_preview,
		Name = "",
		BackgroundTransparency = 0.5,
		Position = UDim2.new(0, 0, 0, 1),
	...
	local glow_esp = library:create("ImageLabel", {
		Parent = esp_preview,
		Name = "",
		ImageColor3 = themes.preset.accent,
		ScaleType = Enum.ScaleType.Slice,
	...
	library:apply_theme(glow_esp, "accent", "ImageColor3")
	...
	local name_pl = library:create("TextLabel", {
		Parent = playerlist,
		Name = "",
		FontFace = library.font,
		TextColor3 = Color3.fromRGB(170, 170, 170),
	...
	local UIPadding_pl = library:create("UIPadding", {
		Parent = name_pl,
		Name = "",
	})

	local main_pl = library:create("Frame", {
		Parent = playerlist,
		Name = "",
		Position = UDim2.new(0, 4, 0, 4),
		BorderColor3 = Color3.fromRGB(26, 26, 26),
	...
	local tabs_pl = library:create("Frame", {
		Parent = main_pl,
		Name = "",
		Position = UDim2.new(0, 8, 0, 8),
		BorderColor3 = Color3.fromRGB(8, 8, 8),
	...
	local list_pl = library:create("Frame", {
		Parent = tabs_pl,
		Name = "",
	...
	local inline_pl = library:create("Frame", {
		Parent = list_pl,
		Name = "",
		Position = UDim2.new(0, 1, 0, 1),
		BorderColor3 = Color3.fromRGB(0, 0, 0),
	...
	local background_pl = library:create("Frame", {
		Parent = inline_pl,
		Name = "",
		Position = UDim2.new(0, 1, 0, 1),
		BorderColor3 = Color3.fromRGB(0, 0, 0),
	...
	local UIGradient_pl = library:create("UIGradient", {
		Parent = background_pl,
		Name = "",
		Rotation = 90,
		Color = ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)),
	...
	local contrast_pl = library:create("Frame", {
		Parent = background_pl,
		Name = "",
		BorderColor3 = Color3.fromRGB(0, 0, 0),
		Size = UDim2.new(1, 0, 1, 0),
	...
	local UIListLayout_pl = library:create("UIListLayout", {
		Parent = __ScrollingFrame,
		Name = "",
		Padding = UDim.new(0, 4),
		SortOrder = Enum.SortOrder.LayoutOrder,
	...
	local inline_info = library:create("Frame", {
		Parent = info,
		Name = "",
		Position = UDim2.new(0, 1, 0, 1),
		BorderColor3 = Color3.fromRGB(0, 0, 0),
	...
	local background_info = library:create("Frame", {
		Parent = inline_info,
		Name = "",
		Position = UDim2.new(0, 1, 0, 1),
		BorderColor3 = Color3.fromRGB(0, 0, 0),
	...
	local UIGradient_info = library:create("UIGradient", {
	...
	local contrast_info = library:create("Frame", {
		Parent = background_info,
		Name = "",
		BorderColor3 = Color3.fromRGB(0, 0, 0),
		Size = UDim2.new(1, 0, 1, 0),
	...
	local UIPadding_info = library:create("UIPadding", {
	...
	local UIListLayout_info = library:create("UIListLayout", {
		Parent = ScrollingFrame,
		Name = "",
		Padding = UDim.new(0, 4),
		SortOrder = Enum.SortOrder.LayoutOrder,
	...
	local button_inline_2 = library:create("Frame", {
		Parent = Frame,
		Name = "",
		Position = UDim2.new(0, -15, 0, 2),
		BorderColor3 = Color3.fromRGB(19, 19, 19),
	...
	local button_2 = library:create("TextButton", {
		Parent = button_inline_2,
		Name = "",
		FontFace = library.font,
		TextColor3 = Color3.fromRGB(170, 170, 170),
		BorderColor3 = Color3.fromRGB(56, 56, 56),
	...
	local button_inline_3 = library:create("Frame", {
		Parent = Frame,
		Name = "",
		Position = UDim2.new(0, -15, 0, 2),
		BorderColor3 = Color3.fromRGB(19, 19, 19),
	...
	local button_3 = library:create("TextButton", {
		Parent = button_inline_3,
		Name = "",
		FontFace = library.font,
		TextColor3 = Color3.fromRGB(170, 170, 170),
		BorderColor3 = Color3.fromRGB(56, 56, 56),
	...
	local UIListLayout_pl2 = library:create("UIListLayout", {
		Parent = Frame,
		Name = "",
	...
	local accent_line_pl = library:create("Frame", {
		Parent = playerlist,
		Name = "",
		BorderColor3 = Color3.fromRGB(34, 34, 34),
		Size = UDim2.new(1, 0, 0, 2),
	...
	library:apply_theme(accent_line_pl, "accent", "BackgroundColor3")

	local depth_pl = library:create("Frame", {
		Parent = playerlist,
		Name = "",
		BackgroundTransparency = 0.5,
		Position = UDim2.new(0, 0, 0, 1),
	...
	local glow_pl = library:create("ImageLabel", {
		Parent = playerlist,
		Name = "",
		ImageColor3 = themes.preset.accent,
		ScaleType = Enum.ScaleType.Slice,
	...
	library:apply_theme(glow_pl, "accent", "ImageColor3")
	...
	local function create_player(player)
		...
		local TextLabel_name = library:create("TextLabel", {
			Parent = TextButton,
			Name = "",
			FontFace = library.font,
			TextColor3 = Color3.fromRGB(180, 180, 180),
		...
		library:create("UIStroke", {
			Parent = TextLabel_name,
			Name = "",
		})

		local TextLabel_team = library:create("TextLabel", {
			Parent = TextButton,
			Name = "",
			FontFace = library.font,
			TextColor3 = Color3.fromRGB(180, 180, 180),
		...
		library:create("UIStroke", {
			Parent = TextLabel_team,
			Name = "",
		})

		local Frame_sep1 = library:create("Frame", {
			Parent = TextLabel_team,
			Name = "",
		...
		local TextLabel_priority = library:create("TextLabel", {
			Parent = TextButton,
			Name = "",
			FontFace = library.font,
			TextColor3 = Color3.fromRGB(180, 180, 180),
		...
		player_buttons[player.Name].priority = TextLabel_priority

		library:create("UIStroke", {
			Parent = TextLabel_priority,
			Name = "",
		})

		local Frame_sep2 = library:create("Frame", {
			Parent = TextLabel_priority,
			Name = "",
			Position = UDim2.new(0, -10, 0, 0),
			BorderColor3 = Color3.fromRGB(0, 0, 0),
		...
		local UIListLayout_player = library:create("UIListLayout", {
			Parent = TextButton,
			Name = "",
			FillDirection = Enum.FillDirection.Horizontal,
			HorizontalFlex = Enum.UIFlexAlignment.Fill,
		...
		local UIPadding_player = library:create("UIPadding", {
			Parent = TextButton,
			Name = "",
		...
		local line_pl = library:create("Frame", {
			Parent = tabs_pl,
			Name = "",
			BorderColor3 = Color3.fromRGB(0, 0, 0),
			Size = UDim2.new(1, 0, 0, 1),
	...
	local glow_kb = library:create("ImageLabel", {
		Parent = old_kblist,
		Name = "",
		ImageColor3 = themes.preset.accent,
		ScaleType = Enum.ScaleType.Slice,
	...
	library:apply_theme(glow_kb, "accent", "ImageColor3")

	local inline1_kb = library:create("Frame", {
		Parent = old_kblist,
		Name = "",
		BorderColor3 = Color3.fromRGB(0, 0, 0),
		AutomaticSize = Enum.AutomaticSize.XY,
	...
	local accent_line_kb = library:create("Frame", {
		Parent = inline1_kb,
		Name = "",
		BorderColor3 = Color3.fromRGB(34, 34, 34),
		Size = UDim2.new(1, 0, 0, 2),
	...
	library:apply_theme(accent_line_kb, "accent", "BackgroundColor3")

	local name_kb = library:create("TextLabel", {
		Parent = inline1_kb,
		Name = "",
		FontFace = library.font,
		TextColor3 = Color3.fromRGB(170, 170, 170),
	...
	local inline2_kb = library:create("Frame", {
		Parent = inline1_kb,
		Name = "",
		Position = UDim2.new(0, 2, 0, 2),
		BorderColor3 = Color3.fromRGB(0, 0, 0),
	...
	local main_kb = library:create("Frame", {
		Parent = inline2_kb,
		Name = "",
		Position = UDim2.new(0, 2, 0, 2),
		BorderColor3 = Color3.fromRGB(57, 57, 57),
	...
	local tab_inline_kb = library:create("Frame", {
		Parent = main_kb,
		Name = "",
		Position = UDim2.new(0, 6, 0, 6),
		BorderColor3 = Color3.fromRGB(19, 19, 19),
	...
	local tabs_kb = library:create("Frame", {
		Parent = tab_inline_kb,
		Name = "",
		Position = UDim2.new(0, 2, 0, 2),
		BorderColor3 = Color3.fromRGB(56, 56, 56),
		Size = UDim2.new(1, -4, 1, -4),
	...
	local UIPadding_kb = library:create("UIPadding", {
		Parent = tabs_kb,
		Name = "",
	...
	local UIListLayout_kb = library:create("UIListLayout", {
		Parent = tabs_kb,
		Name = "",
		SortOrder = Enum.SortOrder.LayoutOrder,
		HorizontalAlignment = Enum.HorizontalAlignment.Center,
	...
	local UIStroke_kb = library:create("UIStroke", {
		Parent = tabs_kb,
		Name = "",
		Color = Color3.fromRGB(57, 57, 57),
		LineJoinMode = Enum.LineJoinMode.Miter,
	...
	local depth_kb = library:create("Frame", {
		Parent = inline1_kb,
		Name = "",
		BorderColor3 = Color3.fromRGB(0, 0, 0),
		BackgroundTransparency = 0.5,
...
function library:notification(properties)
	...
	function cfg:refresh_notifications()
		for i, notif in ipairs(library.notifications) do
			tween_service:Create(notif, TweenInfo.new(0.3, Enum.EasingStyle.Exponential, Enum.EasingDirection.InOut), { Position = dim2(0, 20, 0, 72 + ((i - 1) * 28)) }):Play()
		end
	end
	...
	task.delay(cfg.time + 0.1, function()
		local foundIndex = table.find(library.notifications, holder)
		if foundIndex then
			table.remove(library.notifications, foundIndex)
		end
...
function library:toggle(properties)
	...
	self.previous_holder = right_components
...
function library:colorpicker(properties)
	...
	self.previous_holder = picker_inline
		...
		while true do
			if selected ~= "normal" then
				cfg.set(
					...
					selected == "fade_alpha" and library.sin or a
				)
			end
			task.wait()
		end
...
local aimbot_section = main_tab:section({ name = "Aimbot", side = "left" })
aimbot_section:toggle({ name = "Enable Aimbot", flag = "aimbot_enabled", default = true })
aimbot_section:slider({ name = "FOV", flag = "aimbot_fov", min = 10, max = 300, default = 90, suffix = "°" })
local aimbot_key = aimbot_section:keybind({ name = "Key", flag = "aimbot_key", key = Enum.KeyCode.E, mode = "hold", keybind_name = "Aimbot" })

local triggerbot_section = main_tab:section({ name = "Triggerbot", side = "right" })
triggerbot_section:toggle({ name = "Enable Triggerbot", flag = "triggerbot_enabled", default = false })
triggerbot_section:slider({ name = "Delay", flag = "triggerbot_delay", min = 0, max = 500, default = 50, suffix = "ms" })

local esp_section = visuals_tab:section({ name = "Player ESP", side = "left" })
esp_section:toggle({ name = "Enabled", flag = "esp_enabled", default = true })
esp_section:toggle({ name = "Boxes", flag = "esp_boxes", default = true })
esp_section:toggle({ name = "Names", flag = "esp_names", default = true })
esp_section:colorpicker({ name = "Box Color", flag = "esp_box_color" })

local world_section = visuals_tab:section({ name = "World", side = "right" })
world_section:slider({ name = "Field of View", flag = "world_fov", min = 70, max = 120, default = 90 })
world_section:colorpicker({ name = "Sky Color", flag = "world_sky_color", default = Color3.fromRGB(100, 150, 255) })

local config_section = misc_tab:section({ name = "Configuration", side = "left" })
local config_dropdown = config_section:dropdown({ name = "Config", flag = "selected_config", items = { "Default" } })
local config_name_box = config_section:textbox({ placeholder = "Config name...", flag = "config_name" })
config_section:button({ name = "Save Config", callback = function()
	local config_name = flags.config_name
	if config_name and config_name ~= "" then
		writefile(library.directory .. "/configs/" .. config_name .. ".cfg", library:get_config())
		library:config_list_update()
		library:notification({ text = "Saved config: " .. config_name })
	else
		library:notification({ text = "Please enter a config name." })
	end
end })
config_section:button({ name = "Load Config", callback = function()
	local selected_config = flags.selected_config
	if selected_config and isfile(library.directory .. "/configs/" .. selected_config .. ".cfg") then
		local content = readfile(library.directory .. "/configs/" .. selected_config .. ".cfg")
		library:load_config(content)
		library:notification({ text = "Loaded config: " .. selected_config })
	else
		library:notification({ text = "Config not found." })
	end
end })
config_section:button({ name = "Refresh List", callback = function()
	library:config_list_update()
	library:notification({ text = "Refreshed config list." })
end })

local ui_section = misc_tab:section({ name = "UI Settings", side = "right" })
ui_section:toggle({ name = "Watermark", flag = "ui_watermark", default = true, callback = function(v) window.toggle_watermark(v) end })
ui_section:toggle({ name = "Keybind List", flag = "ui_keybinds", default = true, callback = function(v) window.toggle_list(v) end })
ui_section:toggle({ name = "Player List", flag = "ui_playerlist", default = true, callback = function(v) window.toggle_playerlist(v) end })
ui_section:colorpicker({ name = "Accent Color", flag = "ui_accent", default = Color3.fromRGB(100, 100, 255), callback = function(c) library:update_theme("accent", c) end })
ui_section:button({ name = "Unload UI", callback = function() library:unload() end })
